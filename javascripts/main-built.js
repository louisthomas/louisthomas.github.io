var bui;(function () { if (!bui || !bui.requirejs) {
if (!bui) { bui = {}; } else { require = bui; }
...
(function (global) {
    ...
    /**
     * Support bui.require.config() to make it easier to cooperate with other
...
bui.requirejs = requirejs;bui.require = require;bui.define = define;
}
}());
bui.define("require.js", function(){});
...
})}),n.each({Height:"height",Width:"width"},function(a,b){n.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,d){n.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(d===!0||e===!0?"margin":"border");return Y(this,function(b,c,d){var e;return n.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?n.css(b,c,g):n.style(b,c,d,g)},b,f?d:void 0,f,null)}})}),n.fn.extend({bind:function(a,b,c){return this.on(a,null,b,c)},unbind:function(a,b){return this.off(a,null,b)},delegate:function(a,b,c,d){return this.on(b,a,c,d)},undelegate:function(a,b,c){return 1===arguments.length?this.off(a,"**"):this.off(b,a||"**",c)}}),n.fn.size=function(){return this.length},n.fn.andSelf=n.fn.addBack,'function' === typeof bui.define && bui.define.amd&&bui.define("jquery",[],function(){return n});var nc=a.jQuery,oc=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=oc),b&&a.jQuery===n&&(a.jQuery=nc),n},b||(a.jQuery=a.$=n),n});
...
(function(){
    ...
    Class.extend = function(prop) {
        ...
        /******************************************/
        //Custom code for bellmedia
        //This will expose the defaultOptions to other modules without the new operator
        //Example:
        //  Captcha.defaultOptions instead of new Captcha().defaultOptions
        Class.defaultOptions = Class.prototype.defaultOptions;
        /******************************************/

        return Class;
    };
})();
bui.define("lib/class", function(){});
 ...
 */
bui.define('modules/Base',['jquery', 'require', 'lib/class'], function ($, require) {
    "use strict";
...
bui.define('modules/tritonPlayer',['modules/Base', 'jquery', 'require'], function (Base, $, require) {
    "use strict";
...
bui.define('modules/videoPlayer',['modules/Base', 'jquery', 'require'], function (Base, $, require) {
    "use strict";
    ...
    var VideoPlayer = Base.extend({
        ...
        createPlayer: function (player) {
            ...
            require([bcModule], function () {
                bui.require(['bc', 'videojs.ima3'], function () {
                    bui.require(['modules/video/video.manager'], function (VideoManager) {
                        VideoManager.init();
...
bui.require(['modules/tritonPlayer', 'modules/videoPlayer'], function(TritonPlayer, VideoPlayer) {
    new TritonPlayer();
    new VideoPlayer();
});
bui.define("main", function(){});
