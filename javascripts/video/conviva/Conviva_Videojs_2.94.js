...
//Test account, use with http://touchstone.conviva.com/
if(_s!=STAT_INIT)_s.gatewayUrl="https://bellmedia-test.testonly.conviva.com";
...
if(_s!=STAT_INIT)_s.clientVersion="2.93.0.24567";
...
if(!_s._polling||!_s._vjsPlayer)return;
...
Utils.getInstance().runProtected(function(){
_s.Log('ConvivaVideojsStreamerProxy.onStalling');
_s.Log('ConvivaVideojsStreamerProxy.onStalled');
_s.SetPlayerState(Conviva.ConvivaStreamerProxy.BUFFERING);
...
var reportedError=_s._convertHtml5Error(
errorEvent?errorEvent.code:0);
_s._declareError(reportedError);
}
},'ConvivaVideojsStreamerProxy.onError');
};

this._convertHtml5Error=function(code){
switch(code){
case 1:
